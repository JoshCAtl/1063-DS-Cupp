 ...
 * ListStack.cpp
 *
 * Inplementation of overloaded parameterized constructor added to the 
 * inplementation file
 *
 * Author: Josh Cupp
 * Date: Oct 14th 2019
...
// Added Overloaded Parameterized constructor
Animal::Animal(string n, double w, double s) {
	
	//Made the data from the input file equal the objects' data
	name = n;
	weight = w;
	scary = s;
}
